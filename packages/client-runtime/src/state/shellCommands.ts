...
export function createShellEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    selectCustomApplication: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:shell:select-custom-application",
      tag: WS_METHODS.shellSelectCustomApplication,
    }),
  };
}

...
import { GenerateColorThemeInput, GenerateColorThemeResult } from "./colorTheme.ts";
import {
...
export const WS_METHODS = {
  ...
  serverGenerateColorTheme: "server.generateColorTheme",
...
export const WsServerGenerateColorThemeRpc = Rpc.make(WS_METHODS.serverGenerateColorTheme, {
  payload: GenerateColorThemeInput,
  success: GenerateColorThemeResult,
